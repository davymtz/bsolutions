...
<body>
    <div class="container border p-2 rounded-bottom">
        ...
        <?php echo form_open(base_url("editPosition"),[],["id"=>$position->id]); ?>
            <div class="form-group">
                <label>Nombre</label>
                <input type="text" name="name" value="<?php echo $position->name; ?>" class="form-control" placeholder="Ingrese nombre" required>
            </div>
            <hr />
